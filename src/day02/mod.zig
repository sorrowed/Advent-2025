...
fn parsePairs(gpa: std.mem.Allocator, input: []const u8) !std.ArrayList(util.Range) {
    var ranges = std.ArrayList(util.Range).empty;
...
fn countIfRange(r: util.Range, pred: fn (number: u64) bool) usize {
    var result: usize = 0;
...
fn addIfRange(r: util.Range, pred: fn (number: u64) bool) u64 {
    var result: u64 = 0;
